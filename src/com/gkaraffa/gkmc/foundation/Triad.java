...
public class Triad extends Chord{
    ...
    public static ArrayList<Chord> getTriadList(Note nTonic, HarmonizableScale hScale) throws MusicException{
	...
	/*
	public Chord firstInversion() throws MusicException{
		NoteSeries nsI = this.getInversionNoteSeries(1);
		Triad tI = new Triad();
